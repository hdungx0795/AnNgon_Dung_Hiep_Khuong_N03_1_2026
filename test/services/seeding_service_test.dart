...
void main() {
  ...
  test('seedAll returns early if local boxes are not empty', () async {
    // Pre-populate boxes to bypass seeding
    ...
    // Verify Hive count did not increase from asset loading
