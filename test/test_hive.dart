...
void _registerAdapters() {
  ...
  if (!Hive.isAdapterRegistered(5)) Hive.registerAdapter(PaymentMethodAdapter());
  if (!Hive.isAdapterRegistered(6)) Hive.registerAdapter(OrderItemModelAdapter());
  if (!Hive.isAdapterRegistered(7)) Hive.registerAdapter(OrderStatusAdapter());
  if (!Hive.isAdapterRegistered(8)) Hive.registerAdapter(CartItemModelAdapter());
  if (!Hive.isAdapterRegistered(9)) Hive.registerAdapter(UserPrefsModelAdapter());
  if (!Hive.isAdapterRegistered(10)) Hive.registerAdapter(VoucherModelAdapter());
  if (!Hive.isAdapterRegistered(11)) Hive.registerAdapter(ChatMessageModelAdapter());
}
